...
## Adapters
Currently adapters exist for [jabbr](https://jabbr.net), [HipChat](https://www.hipchat.com/), [Slack](http://slack.com) and [XMPP](https://www.google.com?#q=xmpp) but with plans to add a CampFire adapter soon. The implementation is extremely similar to Hubot so other adapters could easily be added.
